...
- foundation schema blocks for `Parameter`, `Constant`, `Variable`, and `Distribution`
- shared execution blocks for `Compose`, `Transform`, `Filter`, `Selector`, `Aggregator`, `Kernel`, `Schedule`, `Observe`, and `ClampNormalize`
