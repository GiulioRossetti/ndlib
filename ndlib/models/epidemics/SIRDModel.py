    ...
    def iteration(self, node_status=True):
        ...
        for u in self.active:
            ...
            if u_status == 1:
                ...
                # Recovery or Death phase (competing risks)
                eventp = np.random.random_sample()
                gamma = self.params["model"]["gamma"]
                mu = self.params["model"]["mu"]
                if eventp < gamma:
                    actual_status[u] = 2
                elif eventp < gamma + mu:
                    actual_status[u] = 3
