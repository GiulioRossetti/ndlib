    ...
    def __init__(self, graph, seed=None):
        ...
        self.parameters = {
            "model": {
                ...
                "eta": {"descr": "Waning immunity rate", "range": [0, 1], "optional": False},
            },
            "nodes": {},
            "edges": {},
        }
    ...
    def iteration(self, node_status=True):
        ...
        for u in self.active:
            ...
            if u_status == 1:
                ...
                eventp = np.random.random_sample()
                if eventp < self.params["model"]["eta"]:
                    actual_status[u] = 0
