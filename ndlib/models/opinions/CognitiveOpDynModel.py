...
class CognitiveOpDynModel(DiffusionModel):
    ...
    def set_initial_status(self, configuration=None):
        ...
        T_range = (
            self.params["model"]["T_range_min"],
            self.params["model"]["T_range_max"],
        )
        ...
        B_range = (
            self.params["model"]["B_range_min"],
            self.params["model"]["B_range_max"],
        )
        ...
        s = float(
            self.params["model"]["R_fraction_negative"]
            + self.params["model"]["R_fraction_neutral"]
            + self.params["model"]["R_fraction_positive"]
        )
        R_distribution = (
            self.params["model"]["R_fraction_negative"] / s,
            self.params["model"]["R_fraction_neutral"] / s,
