...
class CognitiveOpDynModel(DiffusionModel):
    ...
    def set_initial_status(self, configuration=None):
        ...
        s=float(self.params['R_fraction_negative']+self.params['R_fraction_neutral']+self.params['R_fraction_positive'])
        R_distribution=(self.params['R_fraction_negative']/s, self.params['R_fraction_neutral']/s, self.params['R_fraction_positive']/s)
